...
//code for big hero 6
document.getElementById('bighero6').addEventListener('click', function() {
    document.getElementById('bighero6').textContent = 'Added Big Hero 6';
    document.getElementById('big').innerText = 'Big Hero 6';
})
